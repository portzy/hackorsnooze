...
$body.on("click", ".edit-btn", function (evt) {
  ...
  $("#edit-story-form").data("storyId", storyId).show();
});

$("#edit-story-form").on("submit", async function (evt) {
  evt.preventDefault();
  ...
  await updateStory(currentUser, storyId, { title, author, url });
...
async function updateStory(user, storyId, storyData) {
